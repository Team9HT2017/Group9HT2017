...
import Haus.TechnicalFramework.Controllers.SettingsController;
...
/**
 * This class will handle the animation that appends inside the canvas
 * 
 */
public class CanvasHandler implements Initializable {
...
//                                && grid[i][j - 1] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadCross.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i + 1][j] == 'R' && grid[i - 1][j] == 'R' && grid[i][j - 1] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadT-Y.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i + 1][j] == 'R' && grid[i - 1][j] == 'R' && grid[i][j + 1] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadT+Y.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j + 1] == 'R' && grid[i][j - 1] == 'R' && grid[i - 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadT-X.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j + 1] == 'R' && grid[i][j - 1] == 'R' && grid[i + 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadT+X.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j + 1] == 'R' && grid[i + 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_road^.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j + 1] == 'R' && grid[i - 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_road}.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j - 1] == 'R' && grid[i - 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadv.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j - 1] == 'R' && grid[i + 1][j] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_road{.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
//                        } else if (grid[i][j + 1] == 'R' || grid[i][j - 1] == 'R') {
//                            gc.drawImage(new Image("../../../DataStorage/img/Isotile_roadY.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                    twoDToIso(new Point(i * 16, j * 16)).y);
...
//
//                    case 'T':
//                        gc.drawImage(new Image("../../../DataStorage/img/Isotile_tree.png"), twoDToIso(new Point(i * 16, j * 16)).x,
//                                twoDToIso(new Point(i * 16, j * 16)).y - 8);
//                        break;
//                }
//                for (DjikstraNode djiNode : djikstraNodes) {
//                    gc.drawImage(new Image("../../../DataStorage/img/NodeImg.png"), twoDToIso(new Point(djiNode.x * 16, djiNode.y * 16)).x, twoDToIso(new Point(djiNode.x * 16, djiNode.y * 16)).y);
//                }
////
////                for ()
////                gc.
