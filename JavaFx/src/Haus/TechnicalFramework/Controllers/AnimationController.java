...
public class AnimationController implements Initializable {
    ...
    private void getScene1 () throws Exception {
        String stop= "./stopServer.sh";
        if (TeacherController.user == "teacher") {
            TeacherController.runScript(stop);
        }
...
//
//// Todo: shortestPath uses the source and distanation, both should be according to parsed Json users & massages
//        //  DjikstraNode.shortestPathAlgorithm (djikstraNodes.get(1), djikstraNodes.get (4),djikstraNodes);
//
//
//// loop through the sourceNdistanation from the Json
//
//
//    }
//
